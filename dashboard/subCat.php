    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Sub Category of <?php echo $cat;?></h4>
                    </div>
                    <div class="content">
                        <form action ="subCat.php?id=$idCat" method="post">
                            <div class="form-top">
                                    ...
                                    <div class="form-group">
                                        <?php
                                            ...
                                            while($i != 5){
                                                echo "<div class='row'>
                                                        <div class='col-lg-6'>
                                                        <input type='text' name ='subCat[$idCat][]' class='form-control border-input' placeholder='Enter A Sub-Category'>
                                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button type="button" class="btn btn-info btn-fill" name="create">Add More Sub-Category</button>
                            ...
                            <div class="form-bottom">
                                <div class="row">
                                     <div class="col-md-10">
                                         <a href="cat.php"><button type="button" class="btn btn-info btn-fill">Cancel</button></a>
                                    </div>
                                    <div class="col-md-2">
                        ...
                        <?php
                            if(isset($_POST['submit'])){
                                $subCat = $_POST['subCat'];
                                foreach($subCat as $sC => $valueC ){

                                    if($valueC != ''){
                                       
                                        $sql1 = "INSERT into subcategory (txtSub, idCat) VALUES ('$valueC[0]','$sC')";
