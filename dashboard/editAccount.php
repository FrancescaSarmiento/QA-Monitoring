                            ...
                            <?php
                                ...
                                if ($result=mysqli_query($db, $queryList)) {
                                    if(mysqli_num_rows($result) > 0) {
                                        echo "<form action='editAccount?id=$id' method='post'>";
                                ...
                                <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name ="u" class="form-control border-input" placeholder="<?php echo $u; ?>" value="<?php echo $u; ?>" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Email address</label>
                                                <input type="email" name ="e" class="form-control border-input" placeholder="<?php echo $e; ?>" value="<?php echo $e; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name ="fn" class="form-control border-input" placeholder="<?php echo $f; ?>" value="<?php echo $f; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Last Name</label>
                                                <input type="text" name ="ln" class="form-control border-input" placeholder="<?php echo $e; ?>" value="<?php echo $l; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    <?php 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name='position' class='form-control border-input' <?php echo $s;  ?> >
                                                   <?php 
                                                    if($p == 'QA'){
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Role</label>
                                                <select name="role" class="form-control border-input" <?php echo $s;  ?> >
                                                    <?php
                                                        if($t == 'Regular'){
                             ...
                             <?php
                                if(isset($_POST['submit'])){
                                    ...
                                    if($t != 'Super Admin' ){
                                        ...
                                        if( $fName != $f || $lName != $l || $email != $e || $uName != $u){
                                            mysqli_query($db, "UPDATE user SET firstname ='$fName', lastname ='$lName', email='$email', username='$uName' WHERE userId = '$id' ");
                                        ...
                                        if($role != $t  || $position != $p || $fName != $f || $lName != $l || $email != $e || $uName != $u){
                                            mysqli_query($db, "UPDATE user SET firstname ='$fName', lastname ='$lName', email='$email', username='$uName', type ='$role', position = '$position' WHERE userId = '$id' ");
